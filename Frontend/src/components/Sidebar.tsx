...
// import { Home, Users, Trash2, Clock, BarChart3, Settings, LogOut } from 'lucide-react';
...
// export function Sidebar({ language, isCollapsed = false }: SidebarProps) {
...
//         {!isCollapsed ? (
//           <>
//             <h1 className="sidebar-title">Addis Ababa Waste Management</h1>
//             <p className="sidebar-welcome">
//               {t.welcome}, <span className="username">{user?.username}</span>
//             </p>
//           </>
//         ) : (
//           <div className="sidebar-logo-collapsed">
//             <div className="collapsed-logo">AW</div>
//           </div>
//         )}
//       </div>
